...
export const getProdcutPhotoController = async (req, res) => {
  try {
...
export const updateProductController = async (req, res) => {
  try {
    ...
    res
      .status(400)
      .send({ success: false, error, message: "Error in Updating product" });
  }
};
...
export const ProductListController = async (req, res) => {
  try {
    ...
    res.status(400).send({
      success: false,
      message: "Error in retrieving Product in pages",
      error,
    });
  }
};
...
export const searchProductController = async (req, res) => {
  try {
    ...
    res.status(400).send({
      success: false,
      message: "Error in Searc Product API",
      error,
    });
  }
};
